...
public abstract class ApiAsyncTask<Params, Progress, Result> {
			...
			protected void done() {
				...
				try {
					...
					message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
							new UserTaskResult<Result>(ApiAsyncTask.this, (Result[]) null));
				...
				message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
						new UserTaskResult<Result>(ApiAsyncTask.this, result));
				message.sendToTarget();
			}
		};
	}
	 ...
	 *         {@link ApiAsyncTask.Status#RUNNING} or {@link ApiAsyncTask.Status#FINISHED}.
	 */
	public final ApiAsyncTask<Params, Progress, Result> execute(Params... params) {
	...
	private static class UserTaskResult<Data> {
		...
		final ApiAsyncTask mTask;
		final Data[] mData;

		@SuppressWarnings("rawtypes")
		UserTaskResult(ApiAsyncTask task, Data... data) {
			mTask = task;
			mData = data;
		}
	}
